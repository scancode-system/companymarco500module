...
Route::prefix('companymarco500')->group(function() {
    ...
    Route::get('/orders/export', 'CompanyMarco500Controller@ordersExport')->name('companymarco500.orders.export');

    Route::get('/products', 'CompanyMarco500Controller@products')->name('companymarco500.products');
    Route::get('/products/export/{subsidiary}', 'CompanyMarco500Controller@productsExport')->name('companymarco500.products.export');
});
